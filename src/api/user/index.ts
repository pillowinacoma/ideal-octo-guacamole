...
export const createUser: RequestHandler<{}, {}, createUserInputType> = async (
  req,
  res
) => {
...
export const updateUser: RequestHandler<{}, {}, updateUserInputType> = async (
  req,
  res
) => {
...
export const deleteUser: RequestHandler<{}, {}, deleteUserInputType> = async (
  req,
  res
) => {
